 ...
 *
 * $Id: WssCreateWizardStep3Validator.java,v 1.1.2.1 2009/07/23 15:59:24 ggennaro Exp $
 */
...
public class WssCreateWizardStep3Validator extends WizardStepValidator {
    ...
    private boolean validServiceName() {
        ...
        wizardBean.gotoStep(WssCreateWizardStep.WSC_SERVICENAME_SECURITY.toInt());
