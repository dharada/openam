 ...
 *
 */
package org.forgerock.identity.openam.xip.services;
 ...
 *
 */
public class XipRequestHandlerServlet extends HttpServlet {
    ...
    Response processXACMLResponse(String realm,String pdpEntityID,
        ...
        RequestHandler handler =
                (RequestHandler) XipRequestHandlerServlet.handlers.get(key);  // TODO -- THis was referencing handlers in the SOAPBindingService class.
        if (handler != null) {
            if (debug.messageEnabled()) {
