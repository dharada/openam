...
public class OpenSSOAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        try {
            Collection<GrantedAuthority> ga = populator.getGrantedAuthoritiesCollection(ssoToken);
            ...
            final AMIdentity identity = IdUtils.getIdentity(ssoToken);
            Map<String, Object> attrs = new HashMap<String,Object>();
            attrs.putAll(identity.getAttributes());
            ((UsernamePasswordAuthenticationToken) authentication).setDetails(attrs);
